...
import styles from './SignUpSetupPin.Style';
...
// import {getForgotPinRequest, getForgotPinVerifyIdentityClear} from './SignUp.Action';
...
const SignUpSetupPinScreen = () => {
  ...
  const handleSubmit = () => {
    ...
    //get question
    navigation.navigate('SignUpQuestionScreen', {pin: pin2});
    ...
    return (
      <View style={styles.toolbar}>
        ...
        <View style={styles.viewWrapTitleToolbar}>
          <Text style={styles.titleToolbar}>Sign Up : Setup PIN</Text>
        </View>
